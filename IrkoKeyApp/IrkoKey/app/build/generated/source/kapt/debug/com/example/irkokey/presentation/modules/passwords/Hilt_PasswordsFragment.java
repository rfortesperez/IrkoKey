 ...
 */
public abstract class Hilt_PasswordsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PasswordsFragment() {
    super();
  }

  Hilt_PasswordsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PasswordsFragment_GeneratedInjector) this.generatedComponent()).injectPasswordsFragment(UnsafeCasts.<PasswordsFragment>unsafeCast(this));
    }
  }
