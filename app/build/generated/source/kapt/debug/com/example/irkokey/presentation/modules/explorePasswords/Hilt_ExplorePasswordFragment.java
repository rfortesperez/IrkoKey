 ...
 */
public abstract class Hilt_ExplorePasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExplorePasswordFragment() {
    super();
  }

  Hilt_ExplorePasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExplorePasswordFragment_GeneratedInjector) this.generatedComponent()).injectExplorePasswordFragment(UnsafeCasts.<ExplorePasswordFragment>unsafeCast(this));
    }
  }
