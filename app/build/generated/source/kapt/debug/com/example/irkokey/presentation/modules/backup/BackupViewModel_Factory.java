...
public final class BackupViewModel_Factory implements Factory<BackupViewModel> {
  ...
  public BackupViewModel_Factory(Provider<UserRepository> userRepositoryProvider,
  ...
  public BackupViewModel get() {
    return newInstance(userRepositoryProvider.get(), passwordRepositoryProvider.get(), encryptionUtilProvider.get());
  }

  public static BackupViewModel_Factory create(Provider<UserRepository> userRepositoryProvider,
      Provider<PasswordRepository> passwordRepositoryProvider,
      Provider<EncryptionUtil> encryptionUtilProvider) {
    return new BackupViewModel_Factory(userRepositoryProvider, passwordRepositoryProvider, encryptionUtilProvider);
  }

  public static BackupViewModel newInstance(UserRepository userRepository,
      PasswordRepository passwordRepository, EncryptionUtil encryptionUtil) {
    return new BackupViewModel(userRepository, passwordRepository, encryptionUtil);
  }
}
