 ...
 */
public abstract class Hilt_BackupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BackupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BackupFragment_GeneratedInjector) this.generatedComponent()).injectBackupFragment(UnsafeCasts.<BackupFragment>unsafeCast(this));
    }
  }
