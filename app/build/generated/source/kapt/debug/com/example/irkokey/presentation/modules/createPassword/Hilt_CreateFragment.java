 ...
 */
public abstract class Hilt_CreateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateFragment_GeneratedInjector) this.generatedComponent()).injectCreateFragment(UnsafeCasts.<CreateFragment>unsafeCast(this));
    }
  }
