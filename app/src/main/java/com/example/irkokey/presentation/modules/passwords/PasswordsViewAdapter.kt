...
class PasswordsViewAdapter(private val passwordList: MutableList<Password>, private val listener: OnItemClick, private val encryptionUtil: EncryptionUtil) : RecyclerView.Adapter<PasswordsViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: RowPasswordBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(password: Password, listener: OnItemClick, encryptionUtil: EncryptionUtil) = with(binding){
